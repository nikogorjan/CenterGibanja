...
const SwiperComponent = () => {
  ...
  useEffect(() => {
    // Fetch data and initialize swiper
    fetch('http://localhost:5174/getdata')
      ...
      .then((result) => {
        ...
        swiperRef.current = new Swiper('.swiper-container', {
          ...
          noSwiping: true, // Disable all swiping
        });
      ...
      return (
        ...
        return (
          <div className="additional-values">
            ...
            <div className="cena">      {isNaN(Number(values[1].replace(',', '.'))) ? values[1] : `${values[1]}€`}
</div>
          </div>
        );
      }
    ...
    <div  className="swiper-main">
      ...
      <div className="swiper-container">
        ...
        <div className="swiper-wrapper">
          {data.map((item, index) => (
            <div className="swiper-slide ponudba-slide" id='slider' onTouchEnd={handleTouchEnd} key={item.iddata}>
              <div
